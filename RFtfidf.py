"""
Classification de texte avec TF-IDF et Random Forest.

Ce script permet de prédire automatiquement la langue d’un texte à partir d’un fichier CSV en utilisant un vectoriseur TF-IDF basé sur des n-grammes de caractères combiné à un classifieur Random Forest
...
3. Construction d’un pipeline : TfidfVectorizer : transforme les textes en vecteurs TF-IDF de n-grammes de caractères; RandomForestClassifier : classifieur prenant en compte les déséquilibres de classes.
